    ...
    <div id="projects">
      ...
      >
        <div className="carousel-inner">
         ...
         {/* Botón "prev" */}
        <button className={`carousel-control-prev ${styles['carousel-button']}`} type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="prev">
          <span className="carousel-control-prev-icon" aria-hidden="true"></span>
          <span className="visually-hidden">Previous</span>
        </button>
        {/* Botón "next" */}
        <button className={`carousel-control-next ${styles['carousel-button']}`} type="button" data-bs-target="#carouselExampleInterval" data-bs-slide="next">
